...
*/
export function create_window(): Promise<WindowHandler>;
/**
*/
...
*/
  static new(other: WindowHandler): WindowHandler;
/**
*/
...
export interface InitOutput {
  ...
  readonly __wbg_windowhandler_free: (a: number) => void;
  readonly windowhandler_new: (a: number) => number;
  readonly windowhandler_run_window_loop: (a: number) => void;
  readonly windowhandler_get_canvas_capture: (a: number, b: number) => void;
  readonly windowhandler_close: (a: number) => void;
  readonly create_window: () => number;
  readonly _entry_point: () => void;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1f9c8fc5224dc6d8: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h31f83ed0cb5c325e: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7bda87daf3b89a23: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hac0630b4b2a71782: (a: number, b: number, c: number) => void;
  readonly __wbindgen_add_to_stack_pointer: (a: number) => number;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h1b7a6017347c6a63: (a: number, b: number, c: number, d: number) => void;
